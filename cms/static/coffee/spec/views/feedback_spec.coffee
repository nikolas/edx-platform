define ["jquery", "common/js/components/views/feedback", "js/views/feedback_notification",
        "js/views/feedback_alert", "common/js/components/views/feedback_prompt", "sinon"],
